...
1134
144
If competition is enabled, set max agents allowed per cell:
11
0.0
1
...
388
Agents on Land
count persons with [pcolor = green]
17
1
11
...
438
Agents at Sea
count persons with [pcolor = blue]
17
1
11
...
"" ""
PENS
"pen-0" 1.0 1 -13360827 true "" "histogram [cost] of patches"
...
979
291
Total times.here all 10,250 cells
sum [times.here] of patches
17
1
11
...
980
339
Agents on high cost cells >= 4
count persons with [cost >= 4]
17
1
11
...
@#$#@#$#@
#Description
Similar to the Sea Crossings model. This model runs with dummy data, including randomly assigned cost values. It can be used to demonstrate the decision making algorithm and perform preliminary uncertainty and sensitivity analysis.  
@#$#@#$#@
default
true
0
